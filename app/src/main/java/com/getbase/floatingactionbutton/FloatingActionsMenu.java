        ...
        extends ViewGroup
{
            ...
            AttributeSet attributeSet)
    {
        ...
        int primaryColor = ThemeUtil.getColor(context, R.attr.colorPrimary);
        int accentColor = ThemeUtil.getColor(context, R.attr.colorAccent);
        ...
        mAddButtonColorNormal = attr.getColor(
                R.styleable.FloatingActionsMenu_fab_addButtonColorNormal, primaryColor);
        mAddButtonColorPressed = attr.getColor(
                R.styleable.FloatingActionsMenu_fab_addButtonColorPressed, accentColor);
